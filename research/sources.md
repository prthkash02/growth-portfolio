...
### 1. Josh Braun
- **Proof:** Creator of the "Poke the Bear" method; advises B2B sales teams on starting conversations without "commission breath." Known for value-first, anti-pushy outreach.
...
- **Collect:** LinkedIn posts + 1 podcast guest appearance.
- **Why high-signal:** Strong on omnichannel, multi-touch outbound and on calling out fake "warm calling" rebrands. Sharp BS-detector.

### 6. Nick Cegelski
- **Proof:** Founder of 30 Minutes to President's Club (#1 sales podcast); co-author of *Cold Calling Sucks (And That's Why It Works)*; insights drawn from 300M+ analyzed cold calls.
...
- **Why high-signal:** Best articulation of using AI to *research and personalize* outbound at scale without sounding like a robot.
...
> *Status: roster locked 2026-06-17. Content collection + per-claim fact-checking happens next.*
